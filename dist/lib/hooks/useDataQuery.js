 ...
 */
export const useDataQuery = (dataQueryKey, fetcher, options = {}) => {
    ...
    useEffect(() => {
        subscribeChanges(hookID, queryKey, onQueryChanges, onInvalidate, onCancelQuery);
        return () => {
    ...
    useEffect(() => {
        ...
        if (metadata.current.prevKey !== queryKey &&
